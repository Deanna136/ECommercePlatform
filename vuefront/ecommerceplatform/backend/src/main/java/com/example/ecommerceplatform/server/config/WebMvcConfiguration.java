...
public class WebMvcConfiguration extends WebMvcConfigurationSupport {
    ...
    public Docket docket1() {
        ...
        Docket docket = new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                //指定生成接口需要扫描的包
                .apis(RequestHandlerSelectors.basePackage("com.example.ecommerceplatform.server.controller.admin"))
    ...
    public Docket docket2() {
        ...
        Docket docket = new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                //指定生成接口需要扫描的包
                .apis(RequestHandlerSelectors.basePackage("com.example.ecommerceplatform.server.controller.buyer"))
                .paths(PathSelectors.any())
                .build();
        return docket;
    }
    ...
    public Docket docket3() {
        ...
        Docket docket = new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                //指定生成接口需要扫描的包
                .apis(RequestHandlerSelectors.basePackage("com.example.ecommerceplatform.server.controller.seller"))
                .paths(PathSelectors.any())
                .build();
        return docket;
    }
