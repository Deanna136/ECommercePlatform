...
.image-preview img { width: 300px; margin-top: 10px; border-radius: 8px; }
.admin-item { display: flex; gap: 20px; padding: 12px; border: 1px solid #eee; margin: 10px 0; }
.edit-btn { background: #409eff; color: white; padding: 6px 12px; border: none; border-radius: 4px; cursor: pointer; }
